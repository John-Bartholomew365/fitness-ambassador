                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-3 lg:w-auto w-[90%] px-6 py-3 bg-[#25D366] text-white font-semibold rounded-xl hover:bg-[#1da851] transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center justify-center lg:w-auto w-[90%] gap-3 px-6 py-3 bg-linear-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] text-white font-semibold rounded-xl hover:opacity-90 transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
                                >
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
